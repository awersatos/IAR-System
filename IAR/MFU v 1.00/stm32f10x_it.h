...
void DMA1_Channel4_IRQHandler(void); //Обработчик прерывания половины заполнения буфера приема  навигатора
...
void EXTI0_IRQHandler(void); //Внешние прерывания линии 0 прием пакета

...
FunctionalState Transceiver_state =DISABLE; //Статус трансивера
...
char SPI_SEND( char data) //Функция приема/передачи символа по SPI
{
  ...
  return SPI_I2S_ReceiveData(SPI1); //Получение принятых данных  
}
...
void RESET_TR(void) //Сброс трансивера по включению питания
{
  ...
  delay_us(1);//Задержка в 1 микросекунду
...
//#endif  
 ...
 Transceiver_state = ENABLE; //Трансивер активен
}
